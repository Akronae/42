...
typedef struct t_buffer
{
	...
	t_key_value_pair	*(*read_key_value_pair)(struct t_buffer *self);
	t_list	*(*read_list)(struct t_buffer *self);
	llong	(*read_llong)(struct t_buffer *self);
	...
	void	(*write_key_value_pair)(struct t_buffer *self, t_key_value_pair *data);
...
t_key_value_pair	*ft_buffer_read_key_value_pair(struct t_buffer *self);
t_list	*ft_buffer_read_list(struct t_buffer *self);
llong	ft_buffer_read_llong(struct t_buffer *self);
...
void	ft_buffer_write_key_value_pair(struct t_buffer *self, t_key_value_pair *data);
