...
{
	if (type == T_TYPE_CHAR)
		return (new_typed_ptr(T_TYPE_CHAR,
				ft_char_to_str(self->read_char(self))));
	...
	else if (type == T_TYPE_KV_PAIR)
		return (new_typed_ptr(T_TYPE_KV_PAIR, self->read_kv_pair(self)));
