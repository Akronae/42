...
typedef struct t_list
{
	...
	void				(*free_by_data)(struct t_list *self,
			t_typed_ptr *data);
	struct t_list		*(*from_str_arr)(struct t_list *self, t_string *arr,
	...
	void				(*push_llong)(struct t_list *self, long long l);
...
void				ft_list_free_by_data(t_list *self,
						t_typed_ptr *data);
t_list				*ft_list_from_str_arr(struct t_list *self, t_string *arr,
						size_t from, size_t to);
...
t_link				*ft_list_insert_at(t_list *self, size_t insert_index,
						t_link *insert_elem);
char				*ft_list_join(t_list *self, t_string delimiter);
