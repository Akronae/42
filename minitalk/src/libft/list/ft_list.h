...
typedef struct t_list
{
	...
	ulong		(*count)(struct t_list *self, t_typed_ptr *data);
	...
	void				(*push_llong)(struct t_list *self, llong l);
	...
	struct t_list		*(*sub)(struct t_list *self, llong from,
			llong to);
...
ulong				ft_list_count(t_list *self, t_typed_ptr *value);
