...
void	*ft_persistent_ptr_operation(enum t_persistent_ptr_op operation, size_t index, void *ptr)
{
...
void	ft_init_persistent_ptr()
{
	...
	{
		ft_persistent_ptr_operation(WRITE, i, ft_if_ptr(i == 0, PERSISTENT_PTR_INITIATED, NULL));
		i++;
	}
}
