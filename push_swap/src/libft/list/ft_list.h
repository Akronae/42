...
typedef struct t_list
{
	...
	struct t_list		*(*find_maxes)(struct t_list *self, t_type of_type, size_t count);
	...
	struct t_list		*(*push_range)(struct t_list *self, struct t_list *to_push, long from, long to);
	void				(*push_char)(struct t_list *self, char c);
	void				(*push_data)(struct t_list *self, enum t_type data_type, void *data);
	...
	t_link				*(*remove_by_data)(struct t_list *self, void *data);
	...
	struct t_list		*(*sub)(struct t_list *self, long long from, long long to);
