...
typedef struct t_list
{
	...
	void				(*free_by_data)(struct t_list *self,
			t_typed_ptr *data);
	struct t_list		*(*from_str_arr)(struct t_list *self, t_str *arr,
	...
	void				(*push_llong)(struct t_list *self, t_llong l);
	...
	struct t_list		*(*sub)(struct t_list *self, t_llong from,
			t_llong to);
	...
	t_link				*(*insert_at)(struct t_list *self, size_t insert_index,
			t_link*insert_elem);
	t_link				*(*insert_data_at)(struct t_list *self,
			size_t insert_index, t_typed_ptr *data);
...
t_ulong				ft_list_count(t_list *self, t_typed_ptr *value);
...
void				ft_list_free_by_data(t_list *self,
						t_typed_ptr *data);
t_list				*ft_list_from_str_arr(struct t_list *self, t_str *arr,
						size_t from, size_t to);
...
t_list				*ft_list_sub(t_list *self, t_llong from, t_llong to);
...
t_link				*ft_list_insert_data_at(t_list *self, size_t insert_index,
						t_typed_ptr *data);
char				*ft_list_join(t_list *self, t_str delimiter);
...
t_list				*ft_split_list(t_str str, t_str separator);
